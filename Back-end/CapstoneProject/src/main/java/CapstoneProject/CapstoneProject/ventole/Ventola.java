...
public class Ventola extends Item {
    ...
    public Ventola(String marca, String nome, String descrizione, double prezzo, LocalDate data_di_rilascio, int potenza_di_picco, int quantità, Categoria categoria, int rpm_min, int rpm_max, boolean pwm, int dimensione) {
